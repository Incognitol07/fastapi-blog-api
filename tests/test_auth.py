...
def test_access_protected_route_with_expired_token(client, test_user):
    # Mock an expired token scenario (requires token generation logic adjustment or mocking)
    expired_token = "expired_access_token_example"
    response = client.get(
        "/auth/protected-route",
